					...
					<div class="events-page-wrap row">
						<div class="col-lg-12 col-12">
							<div class="about-box event-box">
								<p class="top-heading">My Events<span ><a href="javascript:void(0)"> (<span id="myGroupsCount">{{count($myevents)}}</span>)</a></span></p>
								...
								<div class="suggestion-inner-box">
									<div class="pagination-design">{!! $myevents->links('pagination::bootstrap-4') !!}</div>
								</div>
								</div>
							</div>
						</div>
